package javax_swings_menu.jradio_jcheckbox.model;
...
public class ThucDonModel {
    ...
    public void tinhTongTien() {
        ...
        if (this.luaChon_MonChinh.equals("CƠM")) {
            ...
            tongTien += 30000;
        } else if (this.luaChon_MonChinh.equals("BÁNH")) {
            tongTien += 10000;
        }

        StringTokenizer stringTokenizer = new StringTokenizer(this.luaChon_MonPhu, ";");
